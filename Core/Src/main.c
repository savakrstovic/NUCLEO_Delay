...
int main(void)
{
  ...
  MX_TIM6_Init();
  /* USER CODE BEGIN 2 */
  /* PC13 is a plain GPIO_Input in the .ioc and the Tap Tempo button is polled
   * with a shift-register debounce in the TIM6 callback. No EXTI line is
   * configured for it, so there is nothing to disable here. */
